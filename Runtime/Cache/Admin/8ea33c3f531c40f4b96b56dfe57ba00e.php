  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">角色id</span></div></td>
        <td height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">角色名称</span></div></td>
      ...
      <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
        ...
        <td bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19"><?php echo ($v["role_id"]); ?></span></div></td>
        <td bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($v["role_name"]); ?></div></td>
        <td bgcolor="#FFFFFF"><div align="center" class="STYLE21">
        <a href="<?php echo U('distribute',array('role_id'=>$v['role_id']));?>">分配权限</a> |
