...
<tr>
  <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
    <tr>
      ...
      <td height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">类型id</span></div></td>
      <td height="20" bgcolor="d3eaef" class="STYLE6"><div align="left"><span class="STYLE10">类型名称</span></div></td>
      <td height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">属性数量</span></div></td>
    ...
    <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
      ...
      <td bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19"><?php echo ($v["type_id"]); ?></span></div></td>
      <td bgcolor="#FFFFFF" class="STYLE19"><div align="left"><?php echo ($v["type_name"]); ?></div></td>
      <td bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($v["type_attr_num"]); ?></div></td>
      <td bgcolor="#FFFFFF"><div align="center" class="STYLE21">
      <a href="<?php echo U('Attribute/showlist',array('type_id'=>$v['type_id']));?>">属性列表 </a> | <img src="<?php echo (AD_IMG_URL); ?>del.gif" width="10" height="10" /> 删除 | 查看 | 
