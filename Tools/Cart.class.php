...
class Cart{
    ...
    */
    function changeNumber($pd_number,$goods_id){
        
        //1修改商品的数量
        $this->cartInfo[$goods_id]['goods_buy_number'] = $pd_number;
        //2修改单件商品的小计价格
        $this->cartInfo[$goods_id]['goods_total_price'] = $pd_number*$this->cartInfo[$goods_id]['goods_price'];
